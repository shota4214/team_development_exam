...
ActiveRecord::Schema.define(version: 2018_10_05_035232) do
  ...
  create_table "agendas", force: :cascade do |t| #議題
    t.string "title"
    t.text "description"
  ...
  create_table "articles", force: :cascade do |t| #記事
    t.bigint "user_id"
    t.bigint "team_id"
  ...
  create_table "assigns", force: :cascade do |t| #割り当てる
  ...
  create_table "comments", force: :cascade do |t| #コメント
    t.bigint "article_id"
    t.text "content"
    t.bigint "user_id"
    t.datetime "created_at", null: false
